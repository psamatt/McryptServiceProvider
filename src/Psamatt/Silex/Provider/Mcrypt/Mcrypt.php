...
class Mcrypt 
{
     ...
     * @param string $iv_source The source of the IV. Default MCRYPT_DEV_RANDOM
     */
    public function __construct($key, $cipher = MCRYPT_RIJNDAEL_256, $mode = MCRYPT_MODE_CBC, $iv_source = MCRYPT_DEV_RANDOM)
    {
        $this->key = $key;
        $this->cipher = $cipher;
        $this->mode = $mode;
